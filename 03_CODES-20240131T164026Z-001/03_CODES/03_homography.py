...
def get_plan_view(src, dst):
    ...
    return plan_view, dst


def merge_views(src, dst):
    plan_view, dst = get_plan_view(src, dst)
...
# Import src image
src = cv.imread(r'D:\masters\Iaac barcelona\AT barcelona\02 software -1_2\Software_2.1_sem2\images-20240201T070157Z-001\images\thermal\RGB_19_25_56_335.png', -1)
src = cv.resize(src, (src.shape[1]//3, src.shape[0]//3), interpolation = cv.INTER_LINEAR)
src_copy = src.copy()
cv.namedWindow('src')
...
# Import dst image
dst = cv.imread(r'D:\masters\Iaac barcelona\AT barcelona\02 software -1_2\Software_2.1_sem2\images-20240201T070157Z-001\images\rgb\RGB_19_25_56_335.png', -1)
dst = cv.resize(dst, (dst.shape[1]//3, dst.shape[0]//3), interpolation = cv.INTER_LINEAR)
dst_copy = dst.copy()
cv.namedWindow('dst')
