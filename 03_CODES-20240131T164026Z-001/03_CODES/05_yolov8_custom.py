# first train the images with the help of 03_CODES-20240131T164026Z-001/03_CODES/train_yolov8_object_detection_on_custom_dataset.ipynb
# option copy paste this  code in google collab and change the locations and check the code for trial images with the help of trained images
